...
import styles from "./TextAreaMultiInputStyle";
import {Text, TouchableWithoutFeedback, View} from "react-native";
import {TextAreaInput} from "js/UIElements";


class TextAreaMultiInput extends React.Component {
    constructor(props) {
        super(props);
        this.state = {error: ""};
    }
...
TextAreaMultiInput.defaultProps = {
    showRemove: false
};

export default TextAreaMultiInput;
